      ...
      <div className="w-full max-w-7xl mx-auto px-6 md:px-8 relative z-10">
          ...
          <div>
            ...
            <div className="flex gap-5">
              ...
              <Link
                ...
                className="group"
              >
                <Linkedin className="h-5 w-5 text-zinc-500 group-hover:text-blue-500 group-hover:drop-shadow-[0_0_8_px_rgba(59,130,246,0.5)] transition-all duration-300" />
              </Link>
              <Link
                ...
                className="group"
              >
                <Twitter className="h-5 w-5 text-zinc-500 group-hover:text-white group-hover:drop-shadow-[0_0_8_px_rgba(255,255,255,0.5)] transition-all duration-300" />
              </Link>
            </div>
            <div className="mt-8">
              <a
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-zinc-600 text-[11px] font-bold uppercase tracking-wider">
            {t?.copyright || `© ${currentYear} SGM SOFTWARE`}
          </p>

          {/* Right side is intentionally empty per your instruction */}
